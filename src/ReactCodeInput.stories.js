...
// Creation of Props
propVariantStories.addDecorator((story, context) =>
  withInfo("Details")(story)(context)
);
...
propVariantStories
  ...
  .add("pattern", () => (
    <form>
      ...
      />
      <input
        style={{ ...inputStyle, width: "auto", backgroundColor: "lightgray" }}
        type="submit"
        value="Submit"
      />
    </form>
